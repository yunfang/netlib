...
import com.cheers.okhttplibrary.utils.okhttp.download.server.download.DownloadTask;
import com.cheers.okhttplibrary.utils.okhttp.download.server.download.DownloadThreadPool;
...
public class OkDownload {
    ...
    private OkDownload() {
        folder = LocalApplication.DOWNLOAD_FILE_DIRECTORY;
//        GlobalConstant.DOWNLOAD_FILE_DIRECTORY          Environment.getExternalStorageDirectory() + File.separator + "download" + File.separator;
    ...
    public static DownloadTask request(String tag,String video_id,String description,String videolength, Request<File, ? extends Request> request) {
        Map<String, DownloadTask> taskMap = OkDownload.getInstance().getTaskMap();
        DownloadTask task = taskMap.get(tag);
        if (task == null) {
            task = new DownloadTask(tag,video_id, description,videolength,request);
