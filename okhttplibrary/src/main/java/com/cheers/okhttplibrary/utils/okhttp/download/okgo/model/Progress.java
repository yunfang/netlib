...
public class Progress implements Serializable {
    ...
    public static ContentValues buildContentValues(Progress progress) {
        ...
        values.put(VIDEO_ID,progress.videoid);
        values.put(DESCRIPTION,progress.description);
        values.put(VIDEO_LENGTH,progress.videolength);
    ...
    public static Progress parseCursorToBean(Cursor cursor) {
        ...
        progress.videoid = cursor.getString(cursor.getColumnIndex(progress.VIDEO_ID));
        progress.description = cursor.getString(cursor.getColumnIndex(progress.DESCRIPTION));
        progress.videolength = cursor.getString(cursor.getColumnIndex(progress.VIDEO_LENGTH));
