...
import com.cheers.okhttplibrary.utils.okhttp.download.okgo.db.DownloadManager;
import com.cheers.okhttplibrary.utils.okhttp.download.okgo.exception.HttpException;
import com.cheers.okhttplibrary.utils.okhttp.download.okgo.exception.OkGoException;
import com.cheers.okhttplibrary.utils.okhttp.download.okgo.exception.StorageException;
...
import com.cheers.okhttplibrary.utils.okhttp.download.okgo.request.base.Request;
import com.cheers.okhttplibrary.utils.okhttp.download.okgo.utils.HttpUtils;
import com.cheers.okhttplibrary.utils.okhttp.download.okgo.utils.IOUtils;
import com.cheers.okhttplibrary.utils.okhttp.download.okgo.utils.OkLogger;
import com.cheers.okhttplibrary.utils.okhttp.download.server.OkDownload;
import com.cheers.okhttplibrary.utils.okhttp.download.server.task.PriorityRunnable;
...
public class DownloadTask implements Runnable {
    ...
    public DownloadTask(String tag,String video_id,String description,String videolength, Request<File, ? extends Request> request) {
        HttpUtils.checkNotNull(tag, "tag == null");
        progress = new Progress();
        progress.tag = tag;
        progress.folder = OkDownload.getInstance().getFolder();
        progress.url = request.getBaseUrl();
        progress.videoid = video_id;
